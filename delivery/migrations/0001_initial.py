...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeliveryBucketOrder'
        db.create_table(u'delivery_deliverybucketorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('delivery_bucket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['delivery.DeliveryBucket'])),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.Order'])),
        ))
        db.send_create_signal(u'delivery', ['DeliveryBucketOrder'])

        # Adding model 'DeliveryBucket'
        db.create_table(u'delivery_deliverybucket', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
    ...
    def backwards(self, orm):
        # Deleting model 'DeliveryBucketOrder'
        db.delete_table(u'delivery_deliverybucketorder')

        # Deleting model 'DeliveryBucket'
        db.delete_table(u'delivery_deliverybucket')
    ...
    models = {
        ...
        u'delivery.deliverybucketorder': {
            'Meta': {'object_name': 'DeliveryBucketOrder'},
            'delivery_bucket': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['delivery.DeliveryBucket']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
