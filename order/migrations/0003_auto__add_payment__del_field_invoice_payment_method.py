...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'order_payment', (
            ...
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payments', to=orm['order.Invoice'])),
            ('method', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('status', self.gf('django.db.models.fields.CharField')(default='CREA', max_length=4)),
        ...
        # Deleting field 'Invoice.payment_method'
        db.delete_column(u'order_invoice', 'payment_method')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Invoice.payment_method'
        db.add_column(u'order_invoice', 'payment_method',
                      self.gf('django.db.models.fields.CharField')(default='PP', max_length=2),
                      keep_default=False)
    ...
    models = {
        ...
        u'order.payment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payments'", 'to': u"orm['order.Invoice']"}),
            'method': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'raw': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'CREA'", 'max_length': '4'}),
            'when_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'when_updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'shop.category': {
